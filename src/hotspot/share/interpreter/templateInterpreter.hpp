...
class TemplateInterpreter: public AbstractInterpreter {
 ...
 protected:
  ...
  static address _monitor_return_entry[4];
 ...
 public:
  ...
  static address    monitor_enter_return_entry_adr(bool disp) 
    { return disp ? _monitor_return_entry[0] : _monitor_return_entry[1]; }
  static address    monitor_exit_return_entry_adr(bool disp)             
    { return disp ? _monitor_return_entry[2] : _monitor_return_entry[3]; }
